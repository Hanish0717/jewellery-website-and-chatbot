...
const reviews = [
  {
    name: "Ananya R.",
    role: "Bride, 2024",
    text: "The bridal set was a dream — every artisan detail showed. The expert consultation made choosing effortless.",
  },
  {
    name: "Vikram & Priya",
    role: "Anniversary",
    text: "We've been patrons for a decade. The heritage craftsmanship and trust they have built is simply unmatched.",
  },
  {
    name: "Sneha K.",
    role: "Diamond Connoisseur",
    text: "Certified, transparent, and exquisite. The solitaire I purchased exceeded every expectation I had set.",
  },
];
