...
const items = [
  {
    title: "Bridal Sets",
    subtitle: "Heritage · Hand-crafted",
    img: bridal,
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-16 flex flex-col items-start justify-between gap-8 md:mb-24 md:flex-row md:items-end">
          ...
          <p className="max-w-md text-xs md:text-sm leading-relaxed text-muted-foreground font-light">
            Each piece is a celebration of tradition, designed by master artisans and finished with
            uncompromising attention to detail and GIA-certified stones.
          </p>
        </div>
          ...
          {items.map((it) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-6 z-20">
                <div>
                  <p className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] text-gold/90 font-medium">
                    {it.subtitle}
                  </p>
                  <h3 className="mt-2 font-display text-2xl text-white md:text-3xl tracking-wide text-glow">
                    {it.title}
                  </h3>
                </div>
