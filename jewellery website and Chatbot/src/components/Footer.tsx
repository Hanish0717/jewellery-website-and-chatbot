      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 md:grid-cols-4 lg:gap-16">
          <div className="md:col-span-2">
            ...
            <p className="mt-6 max-w-sm text-xs md:text-sm leading-relaxed text-white/45 font-light">
              A heritage atelier crafting heirloom gold and diamond jewellery since 2003, in the
              Srikakulam District, Andhra Pradesh.
            </p>
          </div>

          <div>
            <h4 className="text-[10px] md:text-xs uppercase tracking-[0.25em] font-semibold text-white">
              Explore
            </h4>
            ...
            <ul className="space-y-3.5 text-xs md:text-sm font-light">
              {[
                ...
                <li key={l.name}>
                  <a
                    href={l.href}
                    className="hover:text-gold transition-colors duration-300 tracking-wide"
                  >
                    {l.name}
                  </a>
                </li>
          ...
          <div>
            ...
            <p className="text-xs md:text-sm leading-relaxed font-light space-y-2 text-white/50">
              <span>Palakonda, Andhra Pradesh – 532440</span>
              <br />
              <span className="block mt-1 font-medium text-white/70">+91 98480 22200</span>
              <span className="block hover:text-gold transition-colors">
                <a href="mailto:hello@aurumvault.in">hello@aurumvault.in</a>
              </span>
            </p>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 text-[10px] md:text-xs text-white/35 md:flex-row">
          ...
          <p className="tracking-[0.2em] uppercase font-light">
            Crafted with quiet luxury · Andhra Pradesh, India
          </p>
        </div>
      </div>
    </footer>
